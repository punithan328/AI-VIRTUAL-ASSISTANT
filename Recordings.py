...
import subprocess
import msvcrt
import pyautogui#C:\Users\Punithan\Desktop\JarvisFinal\VideoFile

def Record_Option(option):
    
    audio = pyaudio.PyAudio()
    time_stamp = datetime.datetime.now().strftime('%Y-%m-%d-%H-%M-%S')    
    VideoFile_name = f'C:\\Users\\Punithan\\Desktop\\JarvisFinal\\VideoFile-{time_stamp}.mp4'
    AudioFile_name = f'C:\\Users\\Punithan\\Desktop\\JarvisFinal\\AudioFile-{time_stamp}.wav'
    OutputFileName = f'C:\\Users\\Punithan\\Desktop\\JarvisFinal\\VideoFile-{time_stamp}.mp4'
    frames=[]
